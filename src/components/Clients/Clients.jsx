    ...
    return (
      <div className="item col-xs-6 col-md-3">
        <div className="itemContent">
          <Image
            src={require("../../images/Clients-logo/" +
              clientDetails.image +
              ".png")}
            alt=""
            responsive
            ...
            <div className="container">
              <div className="title col-sm-12 col-md-3">
                ...
                <div className="content">
                  We have a broad spectrum of clients from various industrial
                  sectors.We believe in serving our clients with the utmost
                  efficiency and we ensure that the services we render meet and
                  exceed expectations.
                </div>
              </div>
