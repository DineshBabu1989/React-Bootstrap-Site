      ...
      listDetails: [
        {
          ...
          text:
            "We specialize in developing Microcontroller based automation systems for industrial needs. "
        },
        {
          id: 1,
          ...
          image: "fa fa-cloud",
          text:
            "We are experts in developing Custom IoT based data acquisition, control, and monitoring systems."
        },
        {
          id: 2,
          ...
          image: "fa fa-map",
          text:
            "We tailor make GPS navigation systems with vehicular parameter monitoring using high-end embedded, web technologies."
        },
        {
          id: 3,
          ...
          image: "fa fa-cogs",
          text:
            "We develop hi-end industrial control and automation systems using PLC and HMI."
        },
        {
          id: 4,
          heading: "R & D",
          ...
          text:
            "We collabrate with institutions and research centres to develop your develop your ideas in to products"
        },
        {
          id: 5,
          ...
          text:
            "We offer industrial training on various tools, domains for college students and entry-level engineers"
        }
      ]
    };
  }
